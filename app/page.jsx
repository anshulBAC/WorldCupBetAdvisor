  ...
  return (
    <div className="wrap">
      <div className="topbar">
        ...
        <div>
          <h1 className="title">Singapore Pools — Bet Risk Advisor</h1>
          <p className="subtitle">
            Enter the odds, see the honest math: value, expected return &amp; risk.
          </p>
        </div>
      ...
      <div className="footer">
        SGP Risk Advisor · educational tool, not financial or betting advice · not
        affiliated with Singapore Pools.
        <br />
        All calculations run per-session in your browser. No accounts, no tracking,
        no data stored.
      </div>
    </div>
  );
